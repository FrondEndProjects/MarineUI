...
@Component({
  selector: 'app-settling-agent',
  templateUrl: './settling-agent.component.html',
  styleUrls: ['./settling-agent.component.scss'],
})
export class SettlingAgentComponent implements OnInit {
