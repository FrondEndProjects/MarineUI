  ...
  getConveyanceEdit() {
    ...
    this.masterSer.onPostMethodSync(`${this.ApiUrl1}master/settlingagent/edit`, ReqObj).subscribe(
      (data: any) => {
        ...
        console.log(this.countryList, "fdsfdsfsdfsd");
        ...
        let country = this.countryList.filter((e) => {
          e.Code == conveyanceDetails.CountryId
        })
        console.log(country,"countrycountrycountrycountrycountry");
        
        this.settlingForm.controls['CountryId'].setValue(country[0]?.Code);
