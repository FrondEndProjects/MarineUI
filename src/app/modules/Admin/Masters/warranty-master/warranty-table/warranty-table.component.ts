...
export class WarrantyTableComponent implements OnInit {
  // View child
 ...
 public onEdit(event) {
    console.log(event.WarrantyId);
    
   sessionStorage.setItem('warrantyData', event.WarrantyId);
   this.router.navigateByUrl('Marine/masters/warranty/add-edit');
 }
