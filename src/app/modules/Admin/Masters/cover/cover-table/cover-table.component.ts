...
@Component({
  selector: 'app-cover-table',
  templateUrl: './cover-table.component.html',
  styleUrls: ['./cover-table.component.scss']
})
...
// constructor
  ...
  public onEdit(event) {
    ...
    sessionStorage.setItem('CoverData', JSON.stringify(event.CoverId));
    this.router.navigateByUrl('Marine/masters/cover/add-edit');
  }
