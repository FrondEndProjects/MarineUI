...
// constructor
 ...
 getExistingCountry() {
  let ReqObj = {
   ...
   this.masterSer.onPostMethodSync(`${this.ApiUrl1}master/country/list`, ReqObj).subscribe(
     (data: any) => {
 ...
 public onEdit(event) {
  console.log(event.CountryName);
   ...
   sessionStorage.setItem('editCountryId',event.CountryId);
   sessionStorage.setItem('editCountryName',event.CountryName);
   this.router.navigateByUrl('Marine/masters/country/add-edit');
 }
