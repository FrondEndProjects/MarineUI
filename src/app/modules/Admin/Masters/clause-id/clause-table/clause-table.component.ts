...
@Component({
  selector: 'app-clause-table',
  templateUrl: './clause-table.component.html',
  styleUrls: ['./clause-table.component.scss']
})
 ...
 // constructor
   ...
   getExistingBank() {
    let ReqObj = {
     ...
     this.masterSer.onPostMethodSync(`${this.ApiUrl1}master/clauses/list`,ReqObj).subscribe(
       (data: any) => {
