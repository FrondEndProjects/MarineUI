...
@Component({
  selector: 'app-bank-master-table',
  templateUrl: './bank-master-table.component.html',
  styleUrls: ['./bank-master-table.component.scss']
})
export class BankMasterTableComponent implements OnInit {
