...
@Component({
  selector: 'app-setting-agent-table',
  templateUrl: './setting-agent-table.component.html',
  styleUrls: ['./setting-agent-table.component.scss']
})
export class SettingAgentTableComponent implements OnInit {
