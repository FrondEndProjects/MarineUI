 ...
 // constructor
   ...
   getExistingBank() {
    let ReqObj = {
     ...
     this.masterSer.onPostMethodSync(`${this.ApiUrl1}master/commodity/list`, ReqObj).subscribe(
       (data: any) => {
         if (data?.Message === 'Success') {
           console.log(data);
          this.columnHeader = [
            {key: 'CommodityId', display: 'Commodity ID'},
            {key: 'CommodityName', display: 'Commodity Name'},
