  ...
  getToleranceList() {
    ...
    (data: any) => {
      ...
      if(data.Message == "Success") {
        this.columnHeader = [
          {key: 'ToleranceId', display: 'Tolerance ID'},
          {key: 'ToleranceName', display: 'Tolerance Name'},
          {key: 'ToleranceValue', display: 'Tolerance Value'},
...
public onEdit(event) {
  ...
  sessionStorage.setItem('toleranceData', event.ToleranceId);
  this.router.navigateByUrl('Marine/masters/tolerance/add-edit');
}
